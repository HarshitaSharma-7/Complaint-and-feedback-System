...
const WardenDashboard = () => {
  ...
  const fetchFeedbacks = async () => {
    try {
      const res = await api.get('/feedbacks?category=hostel');
  ...
  return (
    <div className="dashboard-split-layout warden-theme">
      <div className="dashboard-image-panel">
        <img src={wardenImage} alt="Warden overseeing hostel" />
      </div>
      <div className="dashboard-content-panel">
        <h1>Warden Dashboard: Hostel Complaints & feedbacks</h1>
